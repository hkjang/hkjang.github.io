...
const koStaticText = {
  ...
  "answers.title": "말보다 먼저 확인할 수 있는 것들",
  "answers.body":
    "전문성은 수식어보다 결과물에서 드러난다고 생각합니다. 무엇을 만들고, 어떻게 반복하고, 어디서 검증할 수 있는지 담았습니다.",
...
const dynamicCopy = {
  ...
  ko: {
    meta: {
      title: "장형국 | AI·IT 플랫폼 엔지니어와 오픈소스 빌더",
      description: "AI, Kubernetes, 데이터 플랫폼, DevSecOps와 개발 도구를 공개 코드와 실제 업데이트로 보여주는 장형국의 포트폴리오입니다.",
      keywords: "장형국, hkjang, AI, IT, Kubernetes, 데이터 플랫폼, DevSecOps, 개발 자동화, 오픈소스 포트폴리오",
    },
